include(cooking_ingredient)

# modified from copied from seastar's
...
cooking_ingredient (dpdk
  EXTERNAL_PROJECT_ARGS
    SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/src/third_party/seastar/dpdk
    CONFIGURE_COMMAND
      COMMAND
        ${CMAKE_COMMAND} -E chdir <SOURCE_DIR>
...
cooking_ingredient (fmt
  ...
  CMAKE_ARGS
    ...
    -DFMT_TEST=OFF
  EXTERNAL_PROJECT_ARGS
    SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/src/third_party/seastar/fmt)
