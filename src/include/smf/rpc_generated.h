...
inline const compression_flags (&EnumValuescompression_flags())[4] {
  static const compression_flags values[] = {compression_flags_none,
    compression_flags_disabled, compression_flags_zstd, compression_flags_lz4};
  return values;
}

inline const char *const *
EnumNamescompression_flags() {
  static const char *const names[] = {
    "none", "disabled", "zstd", "lz4", nullptr};
  return names;
}

inline const char *
EnumNamecompression_flags(compression_flags e) {
...
inline const char *const *
EnumNamesheader_bit_flags() {
  static const char *const names[] = {"has_payload_headers", nullptr};
  return names;
}

inline const char *
EnumNameheader_bit_flags(header_bit_flags e) {
  const size_t index = static_cast<int>(e) -
                       static_cast<int>(header_bit_flags_has_payload_headers);
...
///
/// layout
/// [ 8bits(compression) + 8bits(bitflags) + 16bits(session) + 32bits(size) +
/// 32bits(checksum) + 32bits(meta) ] total = 128bits == 16bytes
///
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) header FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  header(compression_flags _compression, header_bit_flags _bitflags,
    uint16_t _session, uint32_t _size, uint32_t _checksum, uint32_t _meta)
  ...
  compression_flags compression() const {
    return static_cast<compression_flags>(
      flatbuffers::EndianScalar(compression_));
  }
  ...
  uint16_t session() const { return flatbuffers::EndianScalar(session_); }
  ...
  void mutate_size(uint32_t _size) { flatbuffers::WriteScalar(&size_, _size); }
  /// currently we use (xxhash64 & UINT32_MAX)
  uint32_t checksum() const { return flatbuffers::EndianScalar(checksum_); }
  ...
  /// to call
  ///
  uint32_t meta() const { return flatbuffers::EndianScalar(meta_); }
  void mutate_meta(uint32_t _meta) { flatbuffers::WriteScalar(&meta_, _meta); }
};
FLATBUFFERS_STRUCT_END(header, 16);

struct dynamic_headerT : public flatbuffers::NativeTable {
  typedef dynamic_header TableType;
  static FLATBUFFERS_CONSTEXPR const char *
...
struct dynamic_header FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static const flatbuffers::TypeTable *
  ...
  bool
  KeyCompareLessThan(const dynamic_header *o) const {
    return *key() < *o->key();
  }
  int
  KeyCompareWithValue(const char *val) const {
  ...
  bool
  Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_KEY) && verifier.Verify(key()) &&
           VerifyOffset(verifier, VT_VALUE) && verifier.Verify(value()) &&
           verifier.EndTable();
  }
  dynamic_headerT *UnPack(
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(dynamic_headerT *_o,
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<dynamic_header> Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const dynamic_headerT *_o,
...
struct dynamic_headerBuilder {
  ...
  void
  add_key(flatbuffers::Offset<flatbuffers::String> key) {
    fbb_.AddOffset(dynamic_header::VT_KEY, key);
  }
  void
  add_value(flatbuffers::Offset<flatbuffers::String> value) {
  ...
  flatbuffers::Offset<dynamic_header>
  Finish() {
...
inline flatbuffers::Offset<dynamic_header>
Createdynamic_header(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<dynamic_header>
Createdynamic_headerDirect(flatbuffers::FlatBufferBuilder &_fbb,
  const char *key = nullptr,
  const char *value = nullptr) {
  return smf::rpc::Createdynamic_header(_fbb, key ? _fbb.CreateString(key) : 0,
    value ? _fbb.CreateString(value) : 0);
}

flatbuffers::Offset<dynamic_header> Createdynamic_header(
  flatbuffers::FlatBufferBuilder &_fbb,
  const dynamic_headerT *_o,
  const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct payload_headersT : public flatbuffers::NativeTable {
  ...
  payload_headersT()
    : size(0), checksum(0), compression(compression_flags_none) {}
};
...
struct payload_headers FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<dynamic_header>> *
  dynamic_headers() const {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<dynamic_header>> *>(
      VT_DYNAMIC_HEADERS);
  }
  flatbuffers::Vector<flatbuffers::Offset<dynamic_header>> *
  mutable_dynamic_headers() {
    return GetPointer<
      flatbuffers::Vector<flatbuffers::Offset<dynamic_header>> *>(
      VT_DYNAMIC_HEADERS);
  }
  ...
  bool
  mutate_checksum(uint32_t _checksum) {
  ...
  bool
  mutate_compression(compression_flags _compression) {
    return SetField<int8_t>(
      VT_COMPRESSION, static_cast<int8_t>(_compression), 0);
  }
  bool
  Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_COMPRESSION) && verifier.EndTable();
  }
  payload_headersT *UnPack(
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(payload_headersT *_o,
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<payload_headers> Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const payload_headersT *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct payload_headersBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void
  add_dynamic_headers(flatbuffers::Offset<
    flatbuffers::Vector<flatbuffers::Offset<dynamic_header>>> dynamic_headers) {
    fbb_.AddOffset(payload_headers::VT_DYNAMIC_HEADERS, dynamic_headers);
  }
  void
  add_size(uint32_t size) {
    fbb_.AddElement<uint32_t>(payload_headers::VT_SIZE, size, 0);
  }
  void
  add_checksum(uint32_t checksum) {
    fbb_.AddElement<uint32_t>(payload_headers::VT_CHECKSUM, checksum, 0);
  }
  void
  add_compression(compression_flags compression) {
    fbb_.AddElement<int8_t>(
      payload_headers::VT_COMPRESSION, static_cast<int8_t>(compression), 0);
  }
  ...
  flatbuffers::Offset<payload_headers>
  Finish() {
    const auto end = fbb_.EndTable(start_);
...
inline flatbuffers::Offset<payload_headers>
Createpayload_headers(flatbuffers::FlatBufferBuilder &_fbb,
  flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<dynamic_header>>>
    dynamic_headers = 0,
  uint32_t size = 0,
  uint32_t checksum = 0,
...
inline flatbuffers::Offset<payload_headers>
Createpayload_headersDirect(flatbuffers::FlatBufferBuilder &_fbb,
  const std::vector<flatbuffers::Offset<dynamic_header>> *dynamic_headers =
    nullptr,
  uint32_t size = 0,
  uint32_t checksum = 0,
  compression_flags compression = compression_flags_none) {
  return smf::rpc::Createpayload_headers(_fbb,
    dynamic_headers ?
      _fbb.CreateVector<flatbuffers::Offset<dynamic_header>>(*dynamic_headers) :
      0,
    size, checksum, compression);
}

flatbuffers::Offset<payload_headers> Createpayload_headers(
  flatbuffers::FlatBufferBuilder &_fbb,
  const payload_headersT *_o,
  const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct null_type FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  null_typeT *UnPack(
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(null_typeT *_o,
    const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<null_type> Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const null_typeT *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct null_typeBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  explicit null_typeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  null_typeBuilder &operator=(const null_typeBuilder &);
  flatbuffers::Offset<null_type>
  Finish() {
    const auto end = fbb_.EndTable(start_);
...
inline flatbuffers::Offset<null_type>
Createnull_type(flatbuffers::FlatBufferBuilder &_fbb) {
  null_typeBuilder builder_(_fbb);
  return builder_.Finish();
}

flatbuffers::Offset<null_type> Createnull_type(
  flatbuffers::FlatBufferBuilder &_fbb,
  const null_typeT *_o,
  const flatbuffers::rehasher_function_t *_rehasher = nullptr);

inline dynamic_headerT *
dynamic_header::UnPack(
...
inline void
dynamic_header::UnPackTo(dynamic_headerT *_o,
  const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
...
inline flatbuffers::Offset<dynamic_header>
dynamic_header::Pack(flatbuffers::FlatBufferBuilder &_fbb,
  const dynamic_headerT *_o,
...
Createdynamic_header(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  struct _VectorArgs {
    ...
    const dynamic_headerT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  auto _key = _fbb.CreateString(_o->key);
  auto _value = _o->value.empty() ? 0 : _fbb.CreateString(_o->value);
  return smf::rpc::Createdynamic_header(_fbb, _key, _value);
}

inline payload_headersT *
payload_headers::UnPack(
  const flatbuffers::resolver_function_t *_resolver) const {
...
inline void
payload_headers::UnPackTo(payload_headersT *_o,
  const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = dynamic_headers();
    if (_e) {
      _o->dynamic_headers.resize(_e->size());
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->dynamic_headers[_i] =
          std::unique_ptr<dynamic_headerT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  };
  {
...
inline flatbuffers::Offset<payload_headers>
payload_headers::Pack(flatbuffers::FlatBufferBuilder &_fbb,
  const payload_headersT *_o,
  const flatbuffers::rehasher_function_t *_rehasher) {
...
Createpayload_headers(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  struct _VectorArgs {
    flatbuffers::FlatBufferBuilder *__fbb;
    const payload_headersT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  auto _dynamic_headers =
    _o->dynamic_headers.size() ?
      _fbb.CreateVector<flatbuffers::Offset<dynamic_header>>(
        _o->dynamic_headers.size(),
        [](size_t i, _VectorArgs *__va) {
          return Createdynamic_header(*__va->__fbb,
            __va->__o->dynamic_headers[i].get(), __va->__rehasher);
        },
        &_va) :
      0;
  auto _size = _o->size;
  ...
  return smf::rpc::Createpayload_headers(
    _fbb, _dynamic_headers, _size, _checksum, _compression);
}

inline null_typeT *
null_type::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
...
inline void
null_type::UnPackTo(
  null_typeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
}

inline flatbuffers::Offset<null_type>
null_type::Pack(flatbuffers::FlatBufferBuilder &_fbb,
  const null_typeT *_o,
  const flatbuffers::rehasher_function_t *_rehasher) {
...
Createnull_type(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  struct _VectorArgs {
    flatbuffers::FlatBufferBuilder *__fbb;
    const null_typeT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  return smf::rpc::Createnull_type(_fbb);
}
...
compression_flagsTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    compression_flagsTypeTable};
  static const char *const names[] = {"none", "disabled", "zstd", "lz4"};
...
header_bit_flagsTypeTable() {
  ...
  static const char *const names[] = {"has_payload_headers"};
  static const flatbuffers::TypeTable tt = {
...
headerTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
    {flatbuffers::ET_CHAR, 0, 0}, {flatbuffers::ET_CHAR, 0, 1},
    {flatbuffers::ET_USHORT, 0, -1}, {flatbuffers::ET_UINT, 0, -1},
    {flatbuffers::ET_UINT, 0, -1}, {flatbuffers::ET_UINT, 0, -1}};
  static const flatbuffers::TypeFunction type_refs[] = {
    compression_flagsTypeTable, header_bit_flagsTypeTable};
...
inline const flatbuffers::TypeTable *
payload_headersTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
    {flatbuffers::ET_SEQUENCE, 1, 0}, {flatbuffers::ET_UINT, 0, -1},
    {flatbuffers::ET_UINT, 0, -1}, {flatbuffers::ET_CHAR, 0, 1}};
  static const flatbuffers::TypeFunction type_refs[] = {
    dynamic_headerTypeTable, compression_flagsTypeTable};
  static const char *const names[] = {
    "dynamic_headers", "size", "checksum", "compression"};
  static const flatbuffers::TypeTable tt = {
