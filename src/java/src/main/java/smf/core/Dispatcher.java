...
/**
 * Dispatcher is responsible for managing callbacks based on sessionId (fixme ensure sessionId
 * uniques) Inspired by Dispatcher inside Datastax's Cassandra Java Driver.
 */
